...
class pokemon_4 extends JFrame implements ActionListener{
	...
	public pokemon_4(int g,int p,int j,int c, int q, int r, int s, int bn) {
	...
	public void update(int a,int g,int p,int j,int c, int q, int r, int s, int bn) {
		...
		battle_4 program = new battle_4(a, g, p, j, c, n, m ,l, bn);
