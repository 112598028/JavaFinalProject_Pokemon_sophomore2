...
class pokemon extends JFrame implements ActionListener{
	...
	public pokemon(int g,int p,int j,int c, int q, int r, int s, int bn) {
	...
	public void update(int a,int g,int p,int j,int c, int q, int r, int s, int bn) {
		...
		battle program = new battle(a, g, p, j, c, n, m, l, bn);
