...
public class battle_4 extends JFrame implements ActionListener {
	...
	public battle_4(int path,int g,int p,int j,int c, int q, int r, int s,int bn) {
	...
	public void button(int path){
	    ...
	    String cha_1_path = "images\\250\\7.png";
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 開啟背包，以進行收服
			...
			backpack cc = new backpack(a, 6,w,x,y,z, n, m, l, ballnum);
		}
		// 開啟卡牌，更換精靈
		else if(e.getSource() == BTN15) {
			this.setVisible(false);
			pokemon_4 cc = new pokemon_4(w,x,y,z, n, m, l, ballnum); 
		}
		// 逃跑
