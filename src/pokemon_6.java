...
class pokemon_6 extends JFrame implements ActionListener{
	...
	// 寶貝球參數
	int n, m, l, ballnum;
	public pokemon_6(int g,int p,int j,int c , int q, int r, int s,int bn) {
	...
	public void update(int a,int g,int p,int j,int c, int q, int r, int s,int bn) {
		...
		battle_6 program = new battle_6(a, g, p, j, c, n, m ,l, bn);
